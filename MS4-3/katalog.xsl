	...
	<fo:page-sequence master-reference="Katalog">		
	  <fo:flow flow-name="xsl-region-body">
	   ...
	   <!--<fo:block background-image="trailer.jpg" content-width="165mm" content-height="65mm"> -->
	  	<fo:block font-size="36px" space-before="4cm" space-after="4cm" text-align="center" margin-top="4cm" color="#1abc9c" font-family="verdana">
	  		Allgold Datenbank Katalog
	  	</fo:block>
	   <!--</fo:block>-->
	  
	  <fo:block id="inhalt" font-size="16px" space-before="15mm" space-after="15mm" text-align="center" text-transform="uppercase">
	  	<fo:inline text-decoration="underline" font-weight="bold">
	  		...
	  		<fo:footnote-body>
	  			...
	  			<fo:block font-size="10pt" text-transform="none">
	  				<fo:inline font-size="8pt" baseline-shift="super">1</fo:inline>
	  				Hier finden Sie zum einen wie Fussnoten erstellt werden können und zum anderen werden unter diesem Punkt die verfügbaren Tabellen der Allgold Datenbank angezeigt. Um Details zu den
	  				jeweiligen Datenbanken einzusehen, bitte auf deren Namen klicken.
	  			</fo:block>
	  		</fo:footnote-body>
			</fo:footnote>
	  	</fo:inline>
